...
public sealed class PropertyEditorSlotContainerControl : ContentControl {
    ...
    /// <summary>
    /// Whether this slot is selected. Setting this property automatically affects
    ...
    private readonly AvaloniaPropertyToEventPropertyGetSetBinder<PropertyEditorSlot> isSelectedBinder = new AvaloniaPropertyToEventPropertyGetSetBinder<PropertyEditorSlot>(IsSelectedProperty, nameof(PropertyEditorSlot.IsSelectedChanged), b => b.Model.IsSelected.Box(), (b, v) => b.Model.IsSelected = (bool) v!);
