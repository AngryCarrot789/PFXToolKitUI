...
public abstract class BaseAvaloniaPropertyBinder<TModel> : BaseBinder<TModel> where TModel : class {
    /// <summary>
    ...
    protected BaseAvaloniaPropertyBinder(AvaloniaProperty? property) {
