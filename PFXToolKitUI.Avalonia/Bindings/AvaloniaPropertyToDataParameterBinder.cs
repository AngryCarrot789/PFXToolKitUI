...
public class AvaloniaPropertyToDataParameterBinder<TModel> : BaseAvaloniaPropertyBinder<TModel> where TModel : class, ITransferableData {
    ...
    public AvaloniaPropertyToDataParameterBinder(AvaloniaProperty? property, DataParameter? parameter, Func<object?, object?>? parameterToProperty = null, Func<object?, object?>? propertyToParameter = null) : base(property) {
