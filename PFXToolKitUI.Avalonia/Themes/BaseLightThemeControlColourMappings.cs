...
/// <summary>
/// Default inheritance for the built-in light theme
/// </summary>
public static class BaseLightThemeControlColourMappings {
    public static (string, string?)[] Inheritance => [
        ...
        ("Separator.WithDepth.First.Static.Background",      "ABrush.Tone6.Background.Static"),
        ("Separator.WithDepth.Second.Static.Background",     "ABrush.Tone2.Background.Static"),
    ];
}