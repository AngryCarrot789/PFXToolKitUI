...
public sealed class DataParameterVector2 : DataParameter<Vector2>, IRangedParameter<Vector2> {
    ...
    public DataParameterVector2(Type ownerType, string name, ValueAccessor<Vector2> accessor) : this(ownerType, name, default, accessor) {
    }

    public DataParameterVector2(Type ownerType, string name, Vector2 defValue, ValueAccessor<Vector2> accessor) : this(ownerType, name, defValue, Vector2MinValue, Vector2MaxValue, accessor) {
    }

    public DataParameterVector2(Type ownerType, string name, Vector2 defValue, Vector2 minValue, Vector2 maxValue, ValueAccessor<Vector2> accessor) : base(ownerType, name, defValue, accessor) {
