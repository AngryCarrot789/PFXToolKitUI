...
public abstract class PropertyEditorSlot : BasePropertyEditorItem {
    ...
    /// <summary>
    /// Whether there are handlers currently using this property editor. Inverse of <see cref="IsEmpty"/>
    /// </summary>
    public bool HasHandlers => this.Handlers.Count > 0;

    /// <summary>
    /// Whether there are no handlers currently using this property editor. Inverse of <see cref="HasHandlers"/>
    /// </summary>
    public bool IsEmpty => this.Handlers.Count < 1;

    /// <summary>
    /// Whether this editor has only 1 active handler
    /// </summary>
    public bool IsSingleHandler => this.Handlers.Count == 1;

    /// <summary>
    /// Whether this editor has more than 1 active handlers
    /// </summary>
