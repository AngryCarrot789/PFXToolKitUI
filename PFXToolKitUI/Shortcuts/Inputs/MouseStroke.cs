...
public readonly struct MouseStroke : IInputStroke, IEquatable<MouseStroke> {
    ...
    /// <summary>
    /// Whether the mouse input was released. At the moment, this field is not used for normal shortcut processing, because of the
    ...
    /// <summary>
    /// Whether the current and other mouse strokes are equal (same button, mods,
