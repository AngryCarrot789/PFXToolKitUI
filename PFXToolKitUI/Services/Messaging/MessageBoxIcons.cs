...
public static class MessageBoxIcons {
    // These 5 icons are licenced under MIT https://opensource.org/license/mit
    
    // https://www.svgrepo.com/svg/391092/success-filled
    private const string SuccessIconSvgPath = "M44.8 0a44.8 44.8 90 110 89.6 44.8 44.8 90 010-89.6zm-5.5808 53.6384-9.952-9.9584a3.84 3.84 90 10-5.4336 5.4336l12.672 12.672a3.8272 3.8272 90 005.4336 0l26.24-26.2464a3.84 3.84 90 10-5.4272-5.4336L39.2192 53.6384z";
    ...
    public static readonly Icon SuccessIcon =
        IconManager.Instance.RegisterGeometryIcon(
            nameof(SuccessIcon),
            [new GeometryEntry(SuccessIconSvgPath, BrushManager.Instance.CreateConstant(SKColors.LimeGreen))]);
