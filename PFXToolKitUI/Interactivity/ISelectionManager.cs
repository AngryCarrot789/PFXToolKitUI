...
public interface IListSelectionManager<T> : ISelectionManager<T>, ILightSelectionManager<T>, IBaseListSelectionManager<T> {
    int IBaseSelectionManagerEx<T>.Count => this.SelectedItemList.Count;
}